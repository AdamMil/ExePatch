...
namespace DigitalRune.Windows.TextEditor
{
  ...
  public class TextArea : Control
  {
    ...
    public int MaxVScrollValue
    {
      get
      {
        // return (Document.GetVisibleLine(Document.TotalNumberOfLines - 1) + 1 + TextView.NumberOfVisibleLines * 2 / 3) * TextView.LineHeight;
        return Document.TotalNumberOfLines * TextView.LineHeight;
      }
    }
